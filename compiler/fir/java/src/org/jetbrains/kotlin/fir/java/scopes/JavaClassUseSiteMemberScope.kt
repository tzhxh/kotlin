...
class JavaClassUseSiteMemberScope(
    ...
    fun FirPropertySymbol.getBuiltinSpecialPropertyGetterName(): Name? {
    ...
    fun FirNamedFunctionSymbol.getOverriddenBuiltinWithDifferentJvmName(): FirNamedFunctionSymbol? {
